    ...
    def set_clock(self, tide):
        if self.clock != None:
            try:
                ...
                self.clock.set_digit(3, int(hour / 10))  # Tens
                self.clock.set_digit(2, hour % 10)  # Ones

                # Set minutes
                self.clock.set_digit(1, int(minute / 10))  # Tens
                self.clock.set_digit(0, minute % 10)  # Ones
